...
<html lang="es">
	...
	<body>
								...
								<div class="col-xs-12">
									<div class="row">
										...
										<section class="boxes">
											<div class="col-xs-6 col-sm-3"> 
												<div class="box">
													<div class="top">
														<p>
															<?php VendedorEstrella::formatNumbers(( $lastPeriod ? $lastPeriod->total : 0 )) ?>
												...
												<div class="box">
													<div class="top">
														<p>
															...
															<br>
															<span>
																<?php echo VendedorEstrella::formatNumbers($facturacion->fact_total) ?>
															</span>
														</p>
													</div>
													<div class="bot">
												...
												<div class="box"> 
													<div class="top">
														<p>
															...
															<br>
															<span>
																<?php echo VendedorEstrella::formatNumbers($facturacion->fact_prod_clave) ?>
															</span>
														</p>
													</div>	
													<div class="bot">
										...
										<section class="tables">
											...
											<canvas id="nufarm" width="900" height="300" onmousemove="canvas.displayinfo(event)">
												Tu navegador no soporta este grafico, Intenta utilizar <a href="https://www.google.com/chrome/browser/desktop/index.html">Google Chrome</a>
											</canvas>
										</section>
										<section class="tables">
											<h4>
												...
												<div class="col-xs-12">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														...
														<tr>
															...
															<?php foreach($fact_data as $k => $v): ?>
															<td align="center" valign="middle" class="input"><p><?php VendedorEstrella::formatNumbers($v->facturacion_total) ?></p></td>
															<?php endforeach; ?>
														...
														<tr>
															...
															<?php foreach($fact_data as $k => $v): ?>
															<td align="center" valign="middle" class="input"><p><?php VendedorEstrella::formatNumbers($v->facturacion_prod_clave) ?></p></td>
															<?php endforeach; ?>
		...
		<div class="footer" style="position: relative;">
         ...
         <script src="js/graph-client.js"></script>
         <script>
         	var data = '<?php echo json_encode($ve->getGraphData($facturacion->data,$lastPeriod)) ?>';
			var data = JSON.parse(data);
			console.info('Reporting data:', data);

				var canvas = new veCanvas();
					
					canvas.setColumnProperties({hColumn: 40});
					canvas.setWorkSpace({
						paddingLeft: 90,
						paddingBottom: 70,
						paddingTop: 50
